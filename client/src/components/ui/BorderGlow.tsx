...
import { GlowTheme, getCardColorTheme } from '@/lib/card-colors';
...
const BorderGlow = ({
  ...
  // Resolve color values from theme if not explicitly provided as props
  const themeColors = getCardColorTheme(theme);
  const resolvedGlowColor = glowColor || themeColors.glowColor;
  const resolvedColors = colors || themeColors.colors;
