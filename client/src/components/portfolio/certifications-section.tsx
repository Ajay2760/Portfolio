  ...
  const certifications = [
    {
      ...
      organization: "NPTEL",
      description: "12-week comprehensive Java programming course with high level concepts",
      year: "2024",
      icon: Coffee,
      color: "bg-orange-500",
      orgColor: "text-orange-500",
      certificateUrl: "https://drive.google.com/file/d/1hU7uTjXo4CjQ-_QeG_26leY0iBvl0atx/view",
    },
    {
      ...
      certificateUrl: "https://drive.google.com/file/d/1FcMQcxAD2wL-46YnuqsSfeDXmt7NzrV-/view",
    },
    {
      title: "Ethics in the Age of Generative AI",
      organization: "LinkedIn Learning",
      description: "Course covering computer ethics and generative AI principles",
      year: "2023",
      icon: Bot,
      color: "bg-green-500",
      orgColor: "text-green-500",
      certificateUrl: "https://drive.google.com/file/d/1J9gSqwKI5l6wrz6WrFvxExnlMhvSOQ3V/view",
    },
    {
      title: "Design & Implementation of Human-Computer Interfaces",
      organization: "NPTEL",
      description: "12-week course on HCI design and Understanding about Human Interaction with Computers",
      year: "2024",
      icon: Award,
      color: "bg-purple-500",
      orgColor: "text-purple-500",
      certificateUrl: "https://drive.google.com/file/d/1ykZHP9Oa33UZs0ZTcjLSb92oFN77NOaa/view",
    },
  ];
